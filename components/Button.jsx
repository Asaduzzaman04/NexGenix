...
export const RippleButton = ({ children, ...props }) => {
  ...
  return (
    ...
    <motion.button
      className="relative w-full px-6 py-2 rounded-full overflow-hidden border-2 border-hover-button text-hover-button text-text-color transition-colors duration-300"
