...
export const RippleButton = ({ children, ...props }) => {
  ...
  return (
    ...
    <motion.button
      className={ `group focus:text-white active:text-white hover:text-white relative w-full px-6 py-2   rounded-lg overflow-hidden border-2 border-[#330B51]  text-text-color transition-colors duration-300`}
