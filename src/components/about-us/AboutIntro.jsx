...
const AboutIntro = () => {
  ...
  return (
    <section className="relative flex flex-col-reverse md:flex-row items-center justify-around  px-6 md:px-30   md:py-24 overflow-hidden w-full  mx-auto gap-16 md:gap-0 ">
      {/* Left Content (Text) */}
      <motion.div
        ref={leftRef}
      ...
      >
        ...
        <div className="relative">
          ...
          >
            We are dedicated to fostering a vibrant community where every member
            feels valued and engaged. Our mission is to create meaningful
            connections, drive impactful initiatives, and provide resources that
            empower our members. Learn more about our journey, values, and the
